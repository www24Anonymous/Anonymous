...
ins_list = ['alloca','store','load','call','br','ret','icmp','add','sub','bitcast', 'getelementptr', 'srem', 'sext', 'mul', 'select', 'phi','trunc','ashr','zext','and','fmul','fdiv', 'fcmp', 'fadd', 'fpext', 'fptrunc', 'sitofp', 'fptosi', 'switch', 'sdiv'] 
#Predefined number of bits of instruction
ins_width = {'alloca': 64, 'store':32, 'load':32, 'call':64, 'br': 1, 'ret': 32, 'icmp': 1, 'add': 32, 'sub': 32, 'bitcast': 64, 'getelementptr': 64, 'srem': 32, 'sext': 64, 'mul': 64, 'select':32, 'phi': 32, 'trunc':8, 'ashr':64, 'zext':64,'and':64, 'fmul':64,'fdiv':64, 'fcmp':1, 'fadd':64, 'fpext':32, 'fptrunc': 32, 'sitofp':32, 'fptosi':32, 'switch':32, 'sdiv':32}
