...
def parse_args():
    ...
    parser.add_argument('--r', type=int, default=4, help='walks per node')
    parser.add_argument('--l', type=int, default=8, help='walk length')
    parser.add_argument('--k', type=float, default=2, help='window size')
